...
<main>
    <div class="container" style="max-width: 1200px">
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-4 col-md-6">
          <div class="col-xs-12">
            <figure class="contenido">
              <a href="#"
                ><img src="storage/img/img2.jpg" alt="Niña vendimiando"
              /></a>
            </figure>
          </div>
        </div>
        ...
        <div class="row">
          <div
            class="col-xs-12 col-sm-8 col-sm-push-4 col-md-6 col-md-push-6"
          >
          ...
          <div
            class="col-xs-12 col-sm-4 col-sm-pull-8 col-md-6 col-md-pull-6"
          >
            <div class="col-xs-12 col-sm-12">
              <figure class="contenido">
                <a href="#"
                  ><img src="/storage/img/img1.jpg" alt="Perro en la viña"
                /></a>
              </figure>
            </div>
          </div>
